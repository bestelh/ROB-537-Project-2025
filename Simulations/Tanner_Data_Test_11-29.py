...
force_min, force_max = 0.0, 2

# Number of random samples to run
num_samples = 20000  # Adjust for compute budget
...
def main():
    ...
    try:
        ...
        np.savez_compressed('simulation_results_partial_11-31.npz', data=results)
    ...
    if len(results) == num_samples:
        np.savez_compressed('simulation_results_all_11-31.npz', data=results)
